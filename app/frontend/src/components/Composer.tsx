...
export default function Composer({
  running, queueLen, approvals, questions, onSend, onStop, onAnswerApproval, onAnswerQuestions,
}: Props) {
      ...
      <footer className="composer takeover">
        <div className="approval">
          ...
          <div className="approval-actions">
            <button onClick={() => onAnswerApproval(approval, 'rejected')}>拒绝</button>
...
function QuestionPanel({ pending, onAnswer }: { pending: PendingQuestion; onAnswer: (pending: PendingQuestion) => void }) {
